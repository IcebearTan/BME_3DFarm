...
<template>
  <div class="relative group">
    ...
    <!-- hover 预览浮层 -->
    <div class="absolute right-0 top-full mt-1 w-72 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition origin-top z-40">
